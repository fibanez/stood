...
impl CallbackBenchmark {
    ...
    pub async fn benchmark_composite_handler(iterations: usize, handler_count: usize) -> BenchmarkResult {
    ...
    pub fn print_results(results: &[BenchmarkResult]) {
        ...
        println!("═══════════════════════════════════════════════════════════════════");
        println!("{:<30} {:>10} {:>15} {:>15} {:>15}", "Operation", "Iterations", "Total (ms)", "Avg (μs)", "Ops/sec");
        println!("───────────────────────────────────────────────────────────────────");
